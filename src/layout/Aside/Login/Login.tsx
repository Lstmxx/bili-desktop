				...
				<DialogContent className='px-8 py-6'>
					<div className='flex flex-col'>
						...
						<div className='flex flex-col items-center text-sm mt-8 text-info'>
							...
							<span>
								登录或完成注册即代表你同意
								<a className='text-blue' href='https://www.bilibili.com/protocal/licence.html' target='_blank' rel='noreferrer'>
									用户协议
								</a>
								<span> 和 </span>
								<a className='text-blue' href='https://www.bilibili.com/blackboard/privacy-pc.html' target='_blank' rel='noreferrer'>
									隐私政策
								</a>
							</span>
						</div>
